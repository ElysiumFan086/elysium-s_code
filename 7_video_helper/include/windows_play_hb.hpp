...
//DLL导出
#define HBDLLAPI __declspec(dllimport)
...
//打开流
HBDLLAPI HRESULT WINAPI HB_PLAY2_OpenStream( 
	OUT HHBPLAY2* phPlay, 
	IN  LPCVOID   pFileHeader, 
...
HBDLLAPI HRESULT WINAPI HB_PLAY2_SetEnableFlag( 
	IN HHBPLAY2 hPlay, 
	IN DWORD    dwEnableFlag );

HBDLLAPI HRESULT WINAPI HB_PLAY2_GetEnableFlag( 
	IN  HHBPLAY2 hPlay, 
	OUT DWORD*   pdwEnableFlag );
...
HBDLLAPI HRESULT WINAPI HB_PLAY2_SetSpeed( 
	IN HHBPLAY2 hPlay, 
	IN float    fSpeed );
HBDLLAPI HRESULT WINAPI HB_PLAY2_GetSpeed( 
	IN  HHBPLAY2 hPlay, 
	OUT float*   pfSpeed );
...
HBDLLAPI HRESULT WINAPI HB_PLAY2_SetVolume( 
	IN HHBPLAY2 hPlay, 
	IN DWORD    dwVolume );
HBDLLAPI HRESULT WINAPI HB_PLAY2_GetVolume( 
	IN  HHBPLAY2 hPlay, 
	OUT DWORD*   pdwVolume );
