...
#pragma region Audio_Encode_Type
...
#pragma endregion Constant_Value
...
#pragma endregion Struct_Define

#pragma region Proposed_Interface
    ///////////////////////////////////////////////
	//    Proposed Interface 建议使用的接口
	///////////////////////////////////////////////
#pragma region Initialize_Interface
	///<初始化
...
#pragma region Information_Getter
	///<获取信息
...
#define HARD_DECODE_ENGINE 1 ///<硬解码
	...
	PLAYM4_API BOOL __stdcall PlayM4_SetRunTimeInfoCallBack(LONG nPort, void (CALLBACK* RunTimeInfoCBFun)(long nPort, RunTimeInfo* pstRunTimeInfo, void* pUser), void* pUser);
		...
		/*PLAYM4_API int __stdcall PlayM4_SetDecCallBack(LONG nPort,
		void (CALLBACK *DecCBFun_HK)(long nPort, char *pBuf, long nSize, 
		hk::FRAME_INFO *pFrameInfo, void *nReserved1, void *nReserved2));*/
	
	/** 
	 * Function pointer points to Haikang decoding callback function, note that this pointer
	 * is asked to point to a class member function of class type video::HkFrameParser.
	 * @param[in]  nPort      : Played video's port number
	 * @param[in]  pBuf       : Decoded video frame data in YUV12 format
	 * @param[in]  nSize      : Frame data size
	 * @param[out] pFrameInfo : Frame information struct
	 * @param[---] nReserved1 : Reserved parameter, unused now
	 * @param[---] nReserved2 : Reserved parameter, unused now
	 *
	 * @return : No value returned
	 */
	typedef void (CALLBACK *HK_Dcode_CB)
		(long nPort, char *pBuf, long nSize,
		hk::FRAME_INFO *pFrameInfo, void *nReserved1, void *nReserved2);

	PLAYM4_API int CALLBACK PlayM4_SetDecCallBack(LONG nPort, HK_Dcode_CB callBack);
...
#pragma endregion Proposed_Interface

}
#endif //_WINDOWS_PLAYM4_H_